  ...
  return (
    <footer className="mx-auto  flex flex-col md:flex-row pb-12 gap-x-12 mt-20 ">
      <div className="max-w-xs mr-20">
        <Link href={"/"}>
          <Image src={'/Logo.webp'} width={500} height={500} alt="logo" className="flex-shrink-0 h-6 w-32 " />
        </Link>
        ...
        <div className="flex gap-x-4 ">
          <div className="bg-gray-300 py-2 px-2 rounded-xl">
            <Link target="_blank" href={'https://www.linkedin.com/in/rafi-ali-3881a71bb'}>
      ...
      <div className="mr-10 ">
        {/* first c */}
        <h4 className="text-gray-600 mt-6 md:mt-0 font-boold tracking-wider pb-4 text-lg">
          Company
        </h4>
